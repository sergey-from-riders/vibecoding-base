...
Этот документ фиксирует каноническую модель авторизации Go Next Postgres Framework:
...
- `apps/api/internal/auth/*` — core auth logic, providers, sessions, restore.
- `apps/api/internal/company/*` — switch active company.
