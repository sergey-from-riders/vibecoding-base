...
| `18-GO-BACKEND-ENGINEERING-STANDARD` | template-ready | Хорошая декомпозиция и числовые лимиты. | Добавить настоящий Go module skeleton перед первой backend-фичей. |
