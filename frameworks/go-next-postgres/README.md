...
│  ├─ sdk-go/                        # future generated/maintained SDK
...
2. Replace `Go Next Postgres Framework` with your product name where appropriate.
...
```text
Read docs/19-NEXT-NODE-FRONTEND-STANDARD.md and docs/08-UI-CROSS-PLATFORM-RULES.md.
...
1. Bootstrap API runtime: Go module, router, request ID middleware, Problem payloads, docs endpoints.
...
Yes, but update the architecture docs, playbooks, CI, scripts, and standards in the same change. The framework matters more than Go specifically.
