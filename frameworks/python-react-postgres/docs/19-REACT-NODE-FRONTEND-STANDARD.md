# 19. React + Node Frontend Engineering Standard (Strict Numeric + Design Code)
...
8. `ROUTE_LEVEL_CODE_SPLITTING_PERCENT = 100`
9. `CLIENT_STATE_WITHOUT_OWNER = 0`

## 10) Node runtime rules (`src/server`)
