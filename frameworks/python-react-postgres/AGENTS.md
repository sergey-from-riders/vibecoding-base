# AGENTS: Python React Postgres Framework (Vibe Coding 2026)
...
- `apps/api` — Python backend (business rules)
- `apps/web` — React adapter
...
## Python backend implementation rules (READ FIRST)
...
## React/Node frontend implementation rules (READ FIRST)
...
- Qt UI flow must stay parity-aligned with web/React flow and design rules.
